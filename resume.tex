...
\cventry{August 2018 -- present}
  {Software Development Engineer - Alexa Voice Services}{Amazon}{Seattle, WA}{}
    {\vspace{3pt}
    \begin{itemize}
      \setlength{\itemindent}{1em}
      \item Develop Android applications that enable Alexa on third-party multimodal devices
      \item Launch Alexa enabled devices such as the Lenovo Smart Tab to millions of customers
      \item Work with teams across the globe to deliver Alexa experiences that fit the customers' needs
    \end{itemize}
    }
